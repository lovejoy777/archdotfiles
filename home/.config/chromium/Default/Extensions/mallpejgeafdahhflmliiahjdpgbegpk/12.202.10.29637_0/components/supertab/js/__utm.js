/*global _utmcustomPg:true, _ugifpath:true, _partnerID:true, _siteID:true*/
//-- Urchin Tracking Module 6.1 (UTM 6.1) $Revision: 1.24 $
//-- Copyright 2004 Urchin Software Corporation, All Rights Reserved.
//-- Urchin On Demand Settings ONLY
// NB! Modified by Mindspark, Search for "Mindspark edit"
var _uacct="";			// set up the Urchin Account
var _userv=0;			// service mode (0=local,1=remote,2=both)

//-- UTM User Settings
var _ufsc=1;			// set client info flag (1=on|0=off)
//var _udn="mws.ask.com";		// (auto|none|domain) set the domain name for cookies
var _uhash="on";		// (on|off) unique domain hash for cookies
var _utimeout="1800";   	// set the inactive session timeout in seconds
//var _ugifpath="http://utmtrk.mws.ask.com/__utm.gif";	// set the web path to the __utm.gif file
...
_uOsr[20]="iwon";       _uOkw[20]="searchfor";
_uOsr[21]="myway";      _uOkw[21]="searchfor";
_uOsr[22]="mysearch";   _uOkw[22]="searchfor";
_uOsr[23]="mywebsearch";   _uOkw[23]="searchfor";
...
var _uff,_udh,_udt,_udo="",_uu,_ufns=0,_uns=0,_ur="-",_ufno=0,_ust=0,_ujv="-",_ubd=document,_udl=_ubd.location,_uwv="6.1", _udn;
...
if (typeof (_utmcustomPg) === 'undefined') {
	urchinTracker();
}else {
	urchinTracker(_utmcustomPg);
}
...
// Mindspark edit
// This outputs inline script which is a security issue.
// Additionally, this data is useless
/* if (_ujv=="-" && (!page || page=="")) {
  for (var i=5;i>=0;i--) {
...
// Mindspark edit
urchinTracker('/impressions/tabs/landing');